mvn archetype:generate -DgroupId=spring.wwwauthentication -DartifactId=spring.wwwauthentication.annotation -DarchetypeArtifactId=maven-archetype-webapp -DinteractiveMode=false
